...
const movies = [
  ...
  },
  {
    ...
    description: "Bruce Wayne se traslada a Asia, donde es asesorado por su mentor Henri Ducard y Ra's Al Ghul en la liga de las sombras. Al regresar a Gotham, adopta el manto de Batman para liberar a la ciudad de la corrupción.",
    curiosities: "Fue el inicio de la aclamada trilogía del Caballero Oscuro dirigida por Christopher Nolan.",
    cast: [
  ...
  },
  {
    ...
    description: "Ocho años después de asumir la culpa por la muerte de Harvey Dent, un nuevo líder terrorista, Bane, abruma a la policía de Gotham, obligando a Batman a regresar de su exilio.",
    curiosities: "Tom Hardy ganó 13 kilos de músculo para interpretar al imponente y letal villano Bane.",
    cast: [
      { name: "Christian Bale", photo: "" },
      { name: "Tom Hardy", photo: "" }
    ],
  ...
  },
  {
    ...
    description: "En el Año 10191 el desértico planeta Arrakis, feudo de la familia Harkonnen desde hace generaciones, queda en manos de la Casa de los Atreides por orden del emperador. Con ello les cede la explotación de las reservas de especia, pero pronto se verán envueltos en una trama de traiciones y engaños.",
    curiosities: "El director Denis Villeneuve esperó años para dirigir esta película, su proyecto de ensueño de la infancia.",
    cast: [
      { name: "Timothée Chalamet", photo: "" },
  ...
  },
  {
    ...
    description: "Tras la disolución de la Compañía del Anillo, Frodo y su fiel amigo Sam se dirigen hacia Mordor para destruir el Anillo Único y acabar con el poder de Sauron, pero les sigue un siniestro personaje llamado Gollum. Mientras, Aragorn, Legolas y Gimli intentan rescatar a los medianos secuestrados.",
    curiosities: "Andy Serkis revolucionó el cine con su actuación de Gollum mediante captura de movimiento.",
    cast: [
      { name: "Elijah Wood", photo: "" },
      { name: "Viggo Mortensen", photo: "" }
    ],
  ...
  },
  {
    ...
    description: "Dieciséis años después de la muerte de Marco Aurelio, Roma está gobernada por los despiadados emperadores gemelos Geta y Caracalla. El ejército romano invade y conquista Numidia, esclavizando a Lucio, quien debe luchar en el Coliseo para buscar venganza.",
    curiosities: "Ridley Scott volvió a la silla de director más de 20 años después del estreno de la película original.",
    cast: [
  ...
  },
  {
    ...
    description: "Neo, Morpheus, Trinity y el resto de la tripulación continúan en la lucha contra las máquinas que han esclavizado a la raza humana. A medida que aumentan en número, la batalla se acerca a Sion, la última ciudad real en el mundo y centro de la resistencia humana.",
    curiosities: "La épica persecución en la autopista tardó casi tres meses en rodarse en una vía construida exclusivamente para la película.",
    cast: [
      { name: "Keanu Reeves", photo: "" },
      { name: "Carrie-Anne Moss", photo: "" }
    ],
  ...
  },
  {
    ...
    description: "Todo lo que tiene un comienzo tiene un final. La guerra estalla en la superficie de la tierra mientras las máquinas invaden Zion. Allí donde Reloaded significaba vida, Revolutions apunta a la muerte.",
    curiosities: "Fue la primera película de acción real en estrenarse simultáneamente en las principales ciudades del mundo a la misma hora exacta.",
    cast: [
      { name: "Keanu Reeves", photo: "" },
      { name: "Carrie-Anne Moss", photo: "" }
    ],
  ...
  },
  {
    ...
    description: "Neo vive una vida normal y corriente en San Francisco mientras su terapeuta le prescribe pastillas azules. Hasta que Morfeo le ofrece la pastilla roja y vuelve a abrir su mente al mundo de Matrix.",
    curiosities: "Es la única entrega de la saga Matrix que ha sido dirigida en solitario por Lana Wachowski, sin la colaboración de su hermana Lilly.",
    cast: [
      { name: "Keanu Reeves", photo: "" },
      { name: "Carrie-Anne Moss", photo: "" }
    ],
  ...
  },
  {
    ...
    description: "Cuando Shrek y la princesa Fiona regresan de su luna de miel, los padres de ella los invitan a visitar el reino de Muy Muy Lejano. Pero el rey y la maquiavélica Hada Madrina no están nada contentos con su yerno ogro.",
    curiosities: "Mantuvo el récord de ser la película de animación más taquillera de todos los tiempos hasta que fue superada por Toy Story 3.",
    cast: [
      { name: "Mike Myers", photo: "" },
      { name: "Eddie Murphy", photo: "" }
    ],
  ...
  },
  {
    ...
    description: "Tras la repentina enfermedad del Rey Harold, Shrek debe encontrar a un heredero adecuado para el trono de Muy Muy Lejano o tendrá que asumirlo él mismo. Mientras tanto, el resentido Príncipe Encantador organiza un golpe de estado con los villanos de los cuentos.",
    curiosities: "Justin Timberlake le dio la voz al joven rey Arturo ('Artie') en la versión original en inglés.",
    cast: [
      { name: "Mike Myers", photo: "" },
      { name: "Eddie Murphy", photo: "" }
    ],
  ...
  },
  {
    ...
    description: "En lugar de asustar a los aldeanos, el ogro Shrek accede a firmar un pacto con el embaucador Rumpelstiltskin. De pronto se encuentra en una versión alternativa de Muy Muy Lejano donde Fiona no lo conoce y Rumpelstiltskin es el rey.",
    curiosities: "Fue promocionada originalmente como 'El capítulo final' de la franquicia de Shrek antes de que se anunciara una quinta entrega años más tarde.",
    cast: [
      { name: "Mike Myers", photo: "" },
      { name: "Eddie Murphy", photo: "" }
    ],
  ...
  },
  {
    ...
    description: "Quinta entrega de la saga Shrek. Las nuevas y mágicas aventuras del querido ogro verde en compañía de sus amigos inseparables: Asno, la princesa Fiona y el Gato con Botas.",
    curiosities: "Supone el esperado regreso de las voces originales principales tras más de una década de la cuarta entrega.",
    cast: [
      { name: "Mike Myers", photo: "" },
      { name: "Eddie Murphy", photo: "" }
    ],
